...
# PrometheusOperator is installed by default; skip with:
# - PROMETHEUS_OPERATOR_INSTALL_SKIP=true
.PHONY: test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name telemetry-services-operator-builder
	$(CONTAINER_TOOL) buildx use telemetry-services-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm telemetry-services-operator-builder
	rm Dockerfile.cross
